...
function MacOutlookBridgeCard() {
  const [copied, setCopied] = useState(false);
  const installCmd =
    "cd scripts/outlook_bridge && ./install.sh";
    ...
    <Card className="bg-card border-border border-dashed">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0">
              {/* Apple logo — signals "Mac-local" rather than cloud */}
      ...
      <CardContent className="space-y-3">
        <CardDescription className="text-sm text-muted-foreground">
          ...
          registration. A small helper script runs on your Mac every 30
          minutes, reads Outlook for Mac via AppleScript, and pushes
