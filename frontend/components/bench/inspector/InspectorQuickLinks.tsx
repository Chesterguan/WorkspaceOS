  ...
  return (
    <section className="space-y-1">
      ...
      <ul className="space-y-1 text-foreground">
        <li><Link className="hover:underline" href={`/projects/${projectId}/narrative`}>Full narrative form</Link></li>
        ...
        <li><Link className="hover:underline" href={`/projects/${projectId}/blog`}>Blog posts</Link></li>
        <li><Link className="hover:underline" href={`/projects/${projectId}/posting`}>Publishing</Link></li>
      </ul>
    </section>
  );
}
